...
#ifndef _mpu9255_esp32_H_
#define _mpu9255_esp32_H_
#include <Wire.h>
...
public:
  ...
  public:
    ...
    void initMPU9255();
    void calibrateMPU9255(float * gyroBias, float * accelBias);
    void MPU9255SelfTest(float * destination);
    void magCalMPU9255(float * dest1, float * dest2);
